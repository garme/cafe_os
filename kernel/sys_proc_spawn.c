...
/*
 * spawn(task_addr, priority) cria um processo lógico com pilha própria
 * e cópia privada da área .data do processo pai.
 *
 * As rotinas comuns de criação/liberação de processos ficam em
 * kernel/sys_proc.c, que deve ser incluído antes deste arquivo.
 */
