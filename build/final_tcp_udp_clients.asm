...
; ============================================================
overlay_count: DD 2
overlay_table: INITD overlay_0_app_net_client_image, overlay_1_app_net_udp_client_image

; --- /mnt/data/cariri_cafe_os_tcp_udp_v4_1/SO/apps/app_net_client.c ---
overlay_0_app_net_client_image: INITD 0xcafe, 0x0002, 0x0000, 0x1000, 0x04e4, 0x00fa, 0x7000, 0x10bf, 0x00bf, 0x10f5, 0x00f5, 0x50a7
