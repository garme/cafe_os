...
LDA tmp_left
SOP PUSH_OP
MOV overlay_0_app_net_udp_client_image
...
; ============================================================
overlay_count: DD 1
overlay_table: INITD overlay_0_app_net_udp_client_image

; --- /mnt/data/cariri_cafe_os_tcp_udp_v4_1/SO/apps/app_net_udp_client.c ---
overlay_0_app_net_udp_client_image: INITD 0xcafe, 0x0002, 0x0000, 0x1000, 0x03cb, 0x00d6, 0x32ba, 0x609f, 0x10a2, 0x00a2, 0x10d1, 0x00d1
