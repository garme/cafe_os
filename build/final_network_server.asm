...
; ============================================================
overlay_count: DD 1
overlay_table: INITD overlay_0_app_net_server_image

; --- SO/apps/app_net_server.c ---
overlay_0_app_net_server_image: INITD 0xcafe, 0x0002, 0x0000, 0x1000, 0x04a8, 0x0114, 0x7000, 0x60d7, 0x3451, 0x60d8, 0x7000, 0x10e0
