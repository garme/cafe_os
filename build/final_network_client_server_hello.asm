...
CALL kernel_spawn_overlay
SOP POP_OP
MOV overlay_2_app_hello_image
STA overlay_boot_addr_2
LDA overlay_boot_addr_2
SOP PUSH_OP
MOV 4
SOP PUSH_OP
CALL kernel_spawn_overlay
...
; ============================================================
overlay_count: DD 3
overlay_table: INITD overlay_0_app_net_client_image, overlay_1_app_net_server_image, overlay_2_app_hello_image
...
; --- SO/apps/app_hello.c ---
overlay_2_app_hello_image: INITD 0xcafe, 0x0002, 0x0000, 0x1000, 0x006a, 0x001d, 0x7000, 0x6011, 0x3023, 0x6012, 0x3051, 0x6012
